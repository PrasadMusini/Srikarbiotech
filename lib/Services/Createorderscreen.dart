...
// Declare ApiResponse globally
                                          ...
                                          children: [
                                            RichText(
                                              text: TextSpan(
                                                ...
                                                children: [
                                                  TextSpan(
                                                    text: '${productresp.ugpName.toString().split('=')[0]} ',
                                                    style: TextStyle(
                                                      color: Color(0xFF000000), // Orange color before "="
                                                    ),
                                                  ),
                                                  TextSpan(
                                                    text: '=',
                                                    style: TextStyle(
                                                      ...
                                                      fontFamily: "Roboto",
                                                      fontWeight: FontWeight.w600,
                                                      color: Color(0xFF000000), // Black color for "="
                                                    ),
                                                  ),
                                                  TextSpan(
                                                    text: ' ${productresp.ugpName.toString().split('=')[1]}',
                                                    style: TextStyle(
                                                      fontSize: 12,
                                                      fontFamily: "Roboto",
                                                      fontWeight: FontWeight.w600,
                                                      color: Color(0xFFe78337), // Orange color after "="
                                                    ),
                                                  ),
                                                ],
                                              ),
  ...
  void saveData(int index) async {
    ...
    String productData = '${filteredproducts[index].itemCode},${filteredproducts[index].itemName},${quantities[index]}';
